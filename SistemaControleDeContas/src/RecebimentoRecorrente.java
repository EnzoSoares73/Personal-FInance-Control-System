...
public class RecebimentoRecorrente extends Recebimento {
    ...
    private Date dataDoUltimoPagamentoAplicado = getDataDoPagamento();
    ...
    public double aplicaLancamento()  {
        ...
        if (dataDoUltimoPagamentoAplicado == null) {
            ...
            dataDoUltimoPagamentoAplicado = getDataDoPagamento();
        }
    ...
    public void imprimeLancamento() {
        ...
        if (tempo.geraDiferencaEntreDuasDatasEmDias(tempo.geraDataAtual(), dataUltimoPagamento) > 0) {
            ...
            System.out.println("Recebimento ainda ativo");

        } else {

            System.out.println("Recebimento expirado");
